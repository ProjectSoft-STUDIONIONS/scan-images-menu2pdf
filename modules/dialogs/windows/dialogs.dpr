...
(***************************
  ...
  error           Тип ошибки
  Формат
  {"typemenu": "0", "directory": "C:\\Temp\\ScanDir", "data": "1702880641", "author": "ООО «КОМБИНАТ», "produser": "ГБОУ СОШ №__ Город, Поселение", "error": "0"}
          ...
          begin
            try
              ...
              begin
                ...
                jo.Free;
                writeLn(jsn);
                //MessageBox(Form1.Handle, PChar(jsn), PChar('Dialog'), MB_OK);
              end
              else
              begin
